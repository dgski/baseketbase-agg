...
(define sample-posts (list (post 0 0 999 234 1234 0 "Incredible Sights" "Bill Thompson" "" 4 "front")
                           (post 0 0 700 234 344 0 "Castles" "http://discover.com" "" 0 "front")
                           (post 0 0 499 234 233 0 "Nothing" "Bill Hulio" "" 0 "front")
                           (post 0 0 234 23 432 0 "Apple's New iPhone is Triangular" "http://apple.com" "" 0 "front")
                           (post 0 0 580 234 444 0 "Some People still don't know this fact" "http://wikipedia.org" "" 0 "front")
                           (post 0 0 876 0 674 0 "The Artic Ocean at Sundown" "http://nationalgeographic.com" "" 0 "front")
                           (post 0 0 43 0 455 0 "Does anyone need a job in Belfast?" "reginald_papa" "" 0 "front")
                           (post 0 0 77 0 463 0 "The Truth Behind Medicine" "http://popularscience.com" "" 0 "front")
                           (post 0 0 11 0 96 0 "Stoic Philosophy" "http://medium.com" "" 0 "front")
                           (post 0 0 1002 0 124 0 "We Need Biking More than Ever" "http://nytimes.com" "" 0 "front")
                           (post 0 0 300 0 233 0 "Minimalism: Start Guide" "http://medium.com" "" 0 "front")
                           (post 0 0 109 0 453 0 "Avengers: Infinity War - HISHE" "http://youtube.com" "" 0 "front")
                           (post 0 0 10 0 634 0 "When Life Seems like too much.." "http://basket.base" "" 0 "front")
                           (post 0 0 54 0 27 0 "Top Museums, Rome - Pictures" "http://instagram.com" "" 0 "front")
                           ))
